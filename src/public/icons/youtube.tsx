export default function Youtube() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="120" height="60">
      <g transform="matrix(.223746 0 0 .223746 4.958506 17.693975)">
        <path
          ...
          fill="red"
        />
        <path d="M104.6 55L64.2 31.6v46.8z" fill="white" />
        <g fill="white">
      ...
      <defs>
        <path
          id="B"
          d="M311.5 33.4v68.3h-12l-1.3-8.4h-.3c-3.3 6.3-8.2 9.5-14.7 9.5-4.5 0-7.9-1.5-10-4.5-2.2-3-3.2-7.6-3.2-13.9v-51h15.4v50.1c0 3 .3 5.2 1 6.5s1.8 1.9 3.3 1.9c1.3 0 2.6-.4 3.8-1.2s2.1-1.9 2.7-3.1V33.4z"
        />
      </defs>
    </svg>
  );
